...
export function FashionIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className={className} aria-hidden>
      <path d="M12 4a2 2 0 0 1 2 2c1.8 0 3.5 1 4.8 2.6l3.2 4-2 1.4-3-2.3V19H7v-7.3l-3 2.3-2-1.4 3.2-4C6.5 7 8.2 6 10 6a2 2 0 0 1 2-2z" strokeLinejoin="round" />
    </svg>
  );
}
export function BeautyIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className={className} aria-hidden>
      <path d="M12 3c2 3 4 5.5 4 8.5a4 4 0 0 1-8 0C8 8.5 10 6 12 3z" strokeLinejoin="round" />
      <path d="M6 20c.5-1.5 2-2.5 3.5-2.5M18 20c-.5-1.5-2-2.5-3.5-2.5" strokeLinecap="round" />
    </svg>
  );
}
export function LifestyleIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className={className} aria-hidden>
      ...
      <path d="M12 2.5v3M12 18.5v3M2.5 12h3M18.5 12h3M5 5l2 2M17 17l2 2M19 5l-2 2M7 17l-2 2" strokeLinecap="round" />
    </svg>
  );
}
export function TechIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className={className} aria-hidden>
      ...
      <path d="M12 2v3M12 19v3M2 12h3M19 12h3M5 5l1.6 1.6M18.4 18.4 17 17M19 5l-1.6 1.6M5 19l1.6-1.6" strokeLinecap="round" />
    </svg>
  );
}
export function BusinessIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className={className} aria-hidden>
      <path d="M3 20V13M9 20V9M15 20V5M21 20v-8" strokeLinecap="round" />
      <path d="M3 20h18" strokeLinecap="round" />
    </svg>
  );
}
export function ExpertsIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className={className} aria-hidden>
      <path d="M12 2.5 14.6 8l6 .9-4.3 4.2 1 6-5.3-2.8-5.3 2.8 1-6-4.3-4.2 6-.9z" strokeLinejoin="round" />
    </svg>
  );
}
export function MediaIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className={className} aria-hidden>
      <circle cx="12" cy="12" r="9" />
      <path d="m10 8.5 6 3.5-6 3.5z" strokeLinejoin="round" />
    </svg>
  );
}
